...
//This is required if user tries to manually enter view-job-post in URL.
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-job-post"><i class="fa fa-file-o"></i> My Job Post</a></li>
              ...
              <?php
               $sql = "SELECT * FROM users WHERE id_user='$_GET[id]'";
                ...
                <div class="pull-right">
                  <a href="job-applications" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Back</a>
                </div>
                ...
                <div>
                  ...
                  <div class="row">
                    <div class="col-md-3 pull-left">
                      <a href="under-review?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>" class="btn btn-success">Mark Under Review</a>
                    </div>
                    <div class="col-md-3 pull-right">
                      <a href="reject?id=<?php echo $row['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>" class="btn btn-danger">Reject Application</a>
                    </div>
                  </div>
                </div>
