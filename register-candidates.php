...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index" class="logo logo-bg">
      ...
      <span class="logo-mini"><img src="img/logs.png"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="img/logs.png"></span>
    </a>
    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCandidates" action="adduser" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1975-01-01" max="2030-01-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
